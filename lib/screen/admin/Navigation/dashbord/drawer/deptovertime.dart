...
class DeptOvertimeList extends StatefulWidget {
  ...
  @override
  State<DeptOvertimeList> createState() => _DeptOvertimeListState();
}

class _DeptOvertimeListState extends State<DeptOvertimeList> {
  ...
  Future<void> approveOvertime(int id) async {
    try {
      await AdminService.approveOvertime(id, true);

      showTopMessage("Overtime Approved Successfully", isError: false);
  ...
  Future<void> rejectOvertime(int id) async {
    try {
      await AdminService.approveOvertime(id, false);

      showTopMessage("Overtime Rejected Successfully", isError: false);
